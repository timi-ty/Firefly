...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        _currentRotation = Mathf.MoveTowardsAngle(_currentRotation, _targetRotation,
            MathUtils.Angle(_currentRotation, _targetRotation) * _rotationAgility * Time.deltaTime);
        ...
        _currentDirection = Vector2.MoveTowards(_currentDirection, _targetDirection,
            Vector2.Distance(_currentDirection, _targetDirection) * _directionAgility * Time.deltaTime);
    ...
    private void FixedUpdate()
    {
        ...
        Vector2 nextPosition = _velocity * Time.fixedDeltaTime;
